...
const styles = {
  ...
  avatar: { width: '80px', height: '80px', background: 'var(--emerald-500)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '2rem', fontWeight: '700', marginBottom: '1rem' },
  name: { margin: '0 0 0.25rem', fontSize: '1.3rem', fontWeight: '700', color: 'var(--ink-900)' },
  email: { margin: '0 0 0.5rem', color: 'var(--ink-500)', fontSize: '0.9rem' },
  roleBadge: { background: 'var(--emerald-100)', color: 'var(--emerald-600)', padding: '0.25rem 1rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: '600' },
  ...
  saveBtn: { padding: '1rem', background: 'var(--emerald-500)', color: '#fff', border: 'none', borderRadius: '50px', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' },
  cancelBtn: { padding: '1rem', background: 'var(--white)', color: 'var(--ink-500)', border: '1px solid var(--line)', borderRadius: '50px', fontSize: '1rem', cursor: 'pointer' },
  infoSection: { background: 'var(--white)', borderRadius: '16px', padding: '1.5rem', margin: '0 1.5rem 1rem', boxShadow: '0 2px 8px rgba(15,18,38,0.06)' },
  infoRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.6rem 0' },
  infoLabel: { margin: 0, color: 'var(--ink-500)', fontSize: '0.9rem' },
  infoValue: { margin: 0, color: 'var(--ink-900)', fontSize: '0.9rem', fontWeight: '600' },
  divider: { height: '1px', background: 'var(--line)' },
  editBtn: { width: '100%', padding: '0.9rem', background: 'var(--emerald-500)', color: '#fff', border: 'none', borderRadius: '50px', fontSize: '1rem', fontWeight: '600', cursor: 'pointer', marginTop: '1rem' },
